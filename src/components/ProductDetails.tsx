      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="text-center p-4 sm:p-5 bg-blue-50 border-2 border-blue-300 rounded-lg col-span-1 lg:col-span-1">
          <div className="flex items-center justify-center mb-2">
            <TrendingUp className="w-5 h-5 text-blue-700 mr-1" />
            <p className="text-sm sm:text-base font-semibold text-blue-700">Precio UPCItemDB</p>
          </div>
          <p className="text-3xl sm:text-4xl font-bold text-blue-700">${product.precio.toFixed(2)}</p>
        </div>
        ...
        <div className="text-center p-4 sm:p-5 bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-400 rounded-lg col-span-1 lg:col-span-1 shadow-sm">
          <div className="flex items-center justify-center mb-2">
            ...
            <p className="text-sm sm:text-base font-semibold text-orange-700">Precio LÍDER (Reventa)</p>
          </div>
